                ...
                <div className="row mt-5">
                    <div className="col-lg-8">
                            ...
                            <tbody>
                                {cart.map((product, index) => (
                                    <tr key={index}>
                                        ...
                                        <th> <input style={{ width: '60px' }} className='form-control' type="text" value={product.quantity} readOnly /> </th>
                        ...
                        <div className='float-end'>
                            ...
                            <Link to={'/'}><Button   variant="outline-warning">Empty Cart</Button>{' '}</Link>
                        </div>
                    </div>
